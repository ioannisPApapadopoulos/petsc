...
PETSC_EXTERN PetscErrorCode DMPlexCreateSubDMPlex(DM, DM *, DMLabel, PetscInt, PetscInt);
...
PETSC_EXTERN PetscErrorCode DMPlexMarkSubmeshIntersection(DM, DMLabel, PetscInt, DMLabel, PetscInt *, PetscInt, PetscInt);
